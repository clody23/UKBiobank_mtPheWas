...
#ax.legend(handles=handles,markerscale=1,borderpad=0.2,labelspacing=0.5,loc='right',fontsize=14,ncol=1,bbox_to_anchor=(1.65,0.5),fancybox=True,shadow=False,frameon=True,framealpha=0.5,title=t)
#save plot
