...
snps<-read.table("/home/ey246/UKBB_recalling/list_recall3.txt", as.is=T, header=F)

#Aff.1 format

for (i in unlist(snps)){

load (paste0("/home/ey246/UKBB_recalling/intensity/Intensities_UKBB",i,"array_UKBL.RData"))
